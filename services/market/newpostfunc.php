 ...
 */
	...
	if(isset($_POST["Submit"]) && $_POST["Submit"] == "发布"){
		...
		//转义INT值为属性
		include('./itemtypefunc.php');
		include('./itemagefunc.php');
		...
		$sql = "insert into m_post (user,userid,item_name,item_type,item_age,item_img,item_details,item_price,item_contacts,item_tel,item_wechat,pub_time,mod_time) value('$username','$userid','$item_name','$itype','$iage','$mPic','$item_details','$item_price','$item_contacts','$item_tel','$item_wechat','$date','$date')";
